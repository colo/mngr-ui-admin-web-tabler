  ...
  <q-page>
    ...
    <div class="page-header">
      <div class="row align-items-center">
        ...
        <periodical :hosts_data="hosts_data" :selected_hosts="selected_hosts" :selected_domains="selected_domains" period="minute"/>
      </div>
    </div>
...
import periodical from '@apps/system/components/periodical'
/**
* Web components
**/
...
export default {
  ...
  data () {
    return {
      ...
      **/
      store: false,
      pipeline_id: ['input.system.hosts.periodical'],
