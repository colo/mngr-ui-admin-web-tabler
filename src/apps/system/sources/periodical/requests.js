...
const debug = Debug('apps:system:sources:periodical:requests')
...
const system_summary_periodical = {
  params: function (_key, vm) {
    debug('PERIODICAL system_summary_periodical %o %o', _key, vm)
    ...
    if (
      ...
      */
      ...
      // let system_filter = Array.clone(filter)
      // filter.push({ 'metadata': { 'path': 'system.nginx' } })
      ...
      debug('system_summary_periodical FILTER ', filter)
    ...
    debug('PERIODICAL system_summary_periodical %s %o', _key, source)
...
export { system_summary_periodical, periodical, once }
